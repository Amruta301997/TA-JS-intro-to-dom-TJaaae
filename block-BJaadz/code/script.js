...
allHrs.style.boder="1px, solid, tomato";
// Change the background of all the hr to "antiquewhite" using for of loop.
for(let i=0;i<allHrs;i++){
  let color=allHrs.style.backgroundColor="antiquewhite";
  allHrs+=color;
}
...
allHrs.clasName="image";
allHrs.style.border=`2px solid purple`;
...
let box2=document.querySelector('.box two awesome-box');
box2.append(para2);
...
let boxes=document.querySelectorAll('.archive');

let alternative = boxes.filter(function (box){
  return box%2 !==0;
});
alternative.style.backgroundColor='aliceblue';
...
let box9=document.queryCommandValue('.box nine');
